...
TRAIN_FILE = SCRIPT_DIR / "CVD_train_85pct.csv"
TEST_FILE = SCRIPT_DIR / "CVD_test_15pct.csv"
OUTPUT_DIR = SCRIPT_DIR / "output_naive_bayes"
...
CONFIGURAÇÃO:
  ...
  - Dataset Treino: CVD_train_85pct.csv ({len(X_train)} registos)
  - Dataset Teste:  CVD_test_15pct.csv  ({len(X_test)} registos)
